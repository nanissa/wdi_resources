...
Without knowing anything about Ruby you can probably sort of understand how all this works. Nice, right? You'll be building shit in no time.

> **Awesome Detail:** You might notice something interesting – where are the semicolons? You don't need 'em.
...
A local variable is a quick placeholder, and gets forgotten as soon as your method or function is over.
...
An instance variable is a variable that is defined in an instance of an object. That's not meant to be a fancy term - an instance is just an example of an object, one thingy in the great world of things.
...
Use what you just learned about Ruby data types, methods and string interpolation; get on the 'googs'; hop in ```irb```; and get through as many of the following as you can:
...
- Write a method that accepts one parameter: list_of_friends
  - Reassign the list_of_friends in the method to the a string of the joined strings in the array (use the googs!),  interpolate the newly formed string, and print the following to the screen: "Hi there, these are my friends: __________" 
- Call the method 
